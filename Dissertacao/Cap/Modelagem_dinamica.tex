...
\begin{align}
	...
	&= \frac{K_b}{(s^2 \, m - 625) \, (s\, L + R)}
	 \label{eq:dinamica:tfunc}
\end{align}


O sistema obtido pode ser interpretado como de tipo 0 possuindo três polos localizados em:  $[1.21 -1.21 -0.07] \, 10^ 3$ \todo{atualizar}, onde a função de transferência é descrita na Eq. \eqref{eq:dinamica:tfunc}, os parâmetros utilizados foram encontrados nas secções anteriores. 
