...
\begin{figure}[!ht]
	...
	\includegraphics[width=0.5\linewidth]{Figs/Simulacoes/Dinamica/rlocus:pnt:operacao}
	}\\
	%
	\subfloat[b][Diagrama de Bode]{
	\includegraphics[width=0.5\linewidth]{Figs/Simulacoes/Dinamica/bode:pnt:operacao}
	}	
