...
\par
\vspace{90pt}
\hspace*{175pt}\parbox{7.6cm}{{\large lalalaal}}%Dissertação apresentada ao Instituto de Biociências da Universidade de São Paulo, para a obtenção de Título de Mestre em Ciências, na Área de XXXXXXXX.}}
...
\end{enumerate}
I. Universidade de São Paulo. Escola Politécnica. Departamento de XXXXXXXX.
...
\par
\vspace{1em}
\noindent\textbf{Palavras-chave:} Mancal Magnético, Roda de Reação, Controle Multivariável
\newpage
