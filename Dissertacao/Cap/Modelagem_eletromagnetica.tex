...
Sendo $R_{g//}$ a associação paralela entre a relutância do entreferro e o vazamento associado, $R_1$ a soma das relutâncias do circuíto principal e $R_T$ a associação entre as relutâncias dos circuítos 1 e 2 \todo{colocar no texto}. Obtém-se as equações:
