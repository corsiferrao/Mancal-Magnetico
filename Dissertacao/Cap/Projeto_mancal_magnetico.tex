...
Além da linearização obtêm-se um aumento na rigidez axial sem um grande aumento na rigidez radial, o que exigiria uma maior energia da parte ativa para estabilizar o rotor em seu ponto de operação. \todo{melhorar em geral, colocar Eq. ?}
...
\todo[inline]{maximizar a inércia, fixação da inércia}
...
Nesse modo de operação pode-se gerar uma força y e x, para isso basta induzir da mesma maneira um novo campo em (H) e (G). 
...
\end{figure} \todo{referencia ao ima}
