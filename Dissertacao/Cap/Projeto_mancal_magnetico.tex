...
O batente deve ser rígido suficiente para aguentar possíveis impactos do rotor, veremos no Cap. \ref{Cap:Modelagem:Dinamica} que essas forças são da ordem de centenas de Newtons.  \todo{Confuso e falta referẽncia}Propõem a utilização de Nylon ou Teflon \cite{Johnson2001a} na construção do batente devido as suas propriedades de lubrificação a seco. 
