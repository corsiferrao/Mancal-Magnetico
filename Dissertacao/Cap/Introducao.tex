...
A Fig. \ref{fig:EsquemaRoda} ilustra um esquema genérico de uma roda de reação, no caso quatro são os subsistemas: eletrônica de acionamento, motor, mancal e inércia. A eletrônica é responsável pelo controle e acionamento do motor que possui por sua vez, possui um sensor de velocidade e um de corrente. 
...
Com o modelo analítico é possível a utilização de métodos de otimização \todo{citar} para a obtenção de um mancal com dimensões e propriedades magnéticas melhores. 
