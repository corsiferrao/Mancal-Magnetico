...
\begin{frame}{FEM}{Estator externo}
\begin{center}

\only<1>{
$d_y = 0.0 mm $ \\
\includegraphics[width=0.9\linewidth]{../../Dissertacao/Figs/Simulacoes/Passivo2/fem/dy_00}}
\only<2>{
$d_y = 0.4 mm $ \\
\includegraphics[width=0.9\linewidth]{../../Dissertacao/Figs/Simulacoes/Passivo2/fem/dy_04}}
\only<3>{
$d_y = 0.8 mm $ \\
\includegraphics[width=0.9\linewidth]{../../Dissertacao/Figs/Simulacoes/Passivo2/fem/dy_08}}
...
\begin{frame}
	\begin{figure}
	    \begin{columns}
	        \column{.6\linewidth}
				\includegraphics[width=0.5\textheight]{Simulacoes/Ativo/validacao_ativo_map_analitico}
	        \column{.3\linewidth}
				\caption*{Analítico}
	      \end{columns}
	       \begin{columns}
	      	\column{.6\linewidth}
				\includegraphics[width=0.5\textheight]{Simulacoes/Ativo/validacao_ativo_map_fem}
	      	\column{.3\linewidth}
				\caption*{FEM}
   	      \end{columns}
	\end{figure}
